    ...
    public static class WP6_FunctionNames
    {
       ...
       //Skip over embedded EOL subfunctions unless needed in the future.
        ...
        map.Add(new WP6_FunctionKey(0xDD, 11), StyleGroup.global_off);
            ...
            map.Add(new WP6_FunctionKey(0xDE, 0), MergeGroup.beep);
            map.Add(new WP6_FunctionKey(0xDE, 1), MergeGroup._break);
            map.Add(new WP6_FunctionKey(0xDE,2 ), MergeGroup.cancel_off);
            map.Add(new WP6_FunctionKey(0xDE,3 ), MergeGroup.cancel_on);
            map.Add(new WP6_FunctionKey(0xDE, 4), MergeGroup._continue);
            map.Add(new WP6_FunctionKey(0xDE, 5), MergeGroup.date);
            map.Add(new WP6_FunctionKey(0xDE, 6), MergeGroup._default);
            map.Add(new WP6_FunctionKey(0xDE,7 ), MergeGroup.display_stop);
            map.Add(new WP6_FunctionKey(0xDE, 8), MergeGroup._else);
            map.Add(new WP6_FunctionKey(0xDE,9 ), MergeGroup.end_case);
            map.Add(new WP6_FunctionKey(0xDE, 10), MergeGroup.end_field);
            map.Add(new WP6_FunctionKey(0xDE, 11), MergeGroup.end_for);
            map.Add(new WP6_FunctionKey(0xDE,12 ), MergeGroup.end_if);
            map.Add(new WP6_FunctionKey(0xDE,13 ), MergeGroup.end_record);
            map.Add(new WP6_FunctionKey(0xDE,14 ), MergeGroup.end_while);
            map.Add(new WP6_FunctionKey(0xDE, 15), MergeGroup.next);
            map.Add(new WP6_FunctionKey(0xDE, 16), MergeGroup.next_record);
            map.Add(new WP6_FunctionKey(0xDE, 17), MergeGroup.page_off);
            map.Add(new WP6_FunctionKey(0xDE, 18), MergeGroup.page_on);
            map.Add(new WP6_FunctionKey(0xDE, 19), MergeGroup.print);
            map.Add(new WP6_FunctionKey(0xDE, 20), MergeGroup.quit);
            map.Add(new WP6_FunctionKey(0xDE, 21), MergeGroup.process_on);
            map.Add(new WP6_FunctionKey(0xDE, 22), MergeGroup._return);
            map.Add(new WP6_FunctionKey(0xDE, 23), MergeGroup.return_cancel);
            map.Add(new WP6_FunctionKey(0xDE, 24), MergeGroup.return_error);
            map.Add(new WP6_FunctionKey(0xDE, 25), MergeGroup.rewrite);
            map.Add(new WP6_FunctionKey(0xDE, 26), MergeGroup.step_off);
            map.Add(new WP6_FunctionKey(0xDE, 27), MergeGroup.step_on);
            map.Add(new WP6_FunctionKey(0xDE, 28), MergeGroup.stop);
            map.Add(new WP6_FunctionKey(0xDE, 29), MergeGroup.process_off);
            map.Add(new WP6_FunctionKey(0xDE, 30), MergeGroup.FEP_off);
            map.Add(new WP6_FunctionKey(0xDE, 31), MergeGroup.fep_on);
            map.Add(new WP6_FunctionKey(0xDE, 32), MergeGroup.row_repeat);
            map.Add(new WP6_FunctionKey(0xDE, 48), MergeGroup.assign_on);
            map.Add(new WP6_FunctionKey(0xDE, 49), MergeGroup.assign_off);
            map.Add(new WP6_FunctionKey(0xDE, 50), MergeGroup.call_on);
            map.Add(new WP6_FunctionKey(0xDE, 51), MergeGroup.call_off);
            map.Add(new WP6_FunctionKey(0xDE, 52), MergeGroup.caps_on);
            map.Add(new WP6_FunctionKey(0xDE, 53), MergeGroup.caps_off);
            map.Add(new WP6_FunctionKey(0xDE, 54), MergeGroup.case_on);
            map.Add(new WP6_FunctionKey(0xDE, 55), MergeGroup.case_off);
            map.Add(new WP6_FunctionKey(0xDE, 56), MergeGroup.caseof_on);
            map.Add(new WP6_FunctionKey(0xDE, 57), MergeGroup.caseof_off);
            map.Add(new WP6_FunctionKey(0xDE, 58), MergeGroup.chainmacro_on);
            map.Add(new WP6_FunctionKey(0xDE, 59), MergeGroup.chainmacro_off);
            map.Add(new WP6_FunctionKey(0xDE, 60), MergeGroup.chaindata_on);
            map.Add(new WP6_FunctionKey(0xDE, 61), MergeGroup.chaindata_off);
            map.Add(new WP6_FunctionKey(0xDE, 62), MergeGroup.chainform_on);
            map.Add(new WP6_FunctionKey(0xDE, 63), MergeGroup.chainform_off);
            map.Add(new WP6_FunctionKey(0xDE, 64), MergeGroup.char_on);
            map.Add(new WP6_FunctionKey(0xDE, 65), MergeGroup.char_off);
            map.Add(new WP6_FunctionKey(0xDE, 66), MergeGroup.codes_on);
            map.Add(new WP6_FunctionKey(0xDE, 67), MergeGroup.codes_off);
            map.Add(new WP6_FunctionKey(0xDE, 68), MergeGroup.comment_on);
            map.Add(new WP6_FunctionKey(0xDE, 69), MergeGroup.comment_off);
            map.Add(new WP6_FunctionKey(0xDE, 70), MergeGroup.CTON_on);
            map.Add(new WP6_FunctionKey(0xDE, 71), MergeGroup.CTON_off);
            map.Add(new WP6_FunctionKey(0xDE, 72), MergeGroup.document_on);
            map.Add(new WP6_FunctionKey(0xDE, 73), MergeGroup.document_off);
            map.Add(new WP6_FunctionKey(0xDE, 74), MergeGroup.embedmacro_on);
            map.Add(new WP6_FunctionKey(0xDE, 75), MergeGroup.embedmacro_off);
            map.Add(new WP6_FunctionKey(0xDE, 76), MergeGroup.field_on);
            map.Add(new WP6_FunctionKey(0xDE, 77), MergeGroup.field_off);
            map.Add(new WP6_FunctionKey(0xDE, 78), MergeGroup.fieldnames_on);
            map.Add(new WP6_FunctionKey(0xDE, 79), MergeGroup.fieldnames_off);
            map.Add(new WP6_FunctionKey(0xDE, 80), MergeGroup.firstcap_on);
            map.Add(new WP6_FunctionKey(0xDE, 81), MergeGroup.firstcap_off);
            map.Add(new WP6_FunctionKey(0xDE, 82), MergeGroup.for_on);
            map.Add(new WP6_FunctionKey(0xDE, 83), MergeGroup.for_off);
            map.Add(new WP6_FunctionKey(0xDE, 84), MergeGroup.foreach_on);
            map.Add(new WP6_FunctionKey(0xDE, 85), MergeGroup.foreach_off);
            map.Add(new WP6_FunctionKey(0xDE, 86), MergeGroup.getstring_on);
            map.Add(new WP6_FunctionKey(0xDE, 87), MergeGroup.getstring_off);
            map.Add(new WP6_FunctionKey(0xDE, 88), MergeGroup.go_on);
            map.Add(new WP6_FunctionKey(0xDE, 89), MergeGroup.go_off);
            map.Add(new WP6_FunctionKey(0xDE, 90), MergeGroup.if_on);
            map.Add(new WP6_FunctionKey(0xDE, 91), MergeGroup.if_off);
            map.Add(new WP6_FunctionKey(0xDE, 92), MergeGroup.ifblank_on);
            map.Add(new WP6_FunctionKey(0xDE, 93), MergeGroup.ifblank_off);
            map.Add(new WP6_FunctionKey(0xDE, 94), MergeGroup.ifexists_on);
            map.Add(new WP6_FunctionKey(0xDE, 95), MergeGroup.ifexists_off);
            map.Add(new WP6_FunctionKey(0xDE, 96), MergeGroup.ifnotblank_on);
            map.Add(new WP6_FunctionKey(0xDE, 97), MergeGroup.ifnotblank_off);
            map.Add(new WP6_FunctionKey(0xDE, 98), MergeGroup.insert_on);
            map.Add(new WP6_FunctionKey(0xDE, 99), MergeGroup.insert_off);
            map.Add(new WP6_FunctionKey(0xDE, 100), MergeGroup.keyboard_on);
            map.Add(new WP6_FunctionKey(0xDE, 101), MergeGroup.keyboard_off );
            map.Add(new WP6_FunctionKey(0xDE, 102), MergeGroup.label_on);
            map.Add(new WP6_FunctionKey(0xDE, 103), MergeGroup.label_off);
            map.Add(new WP6_FunctionKey(0xDE, 104), MergeGroup.local_on);
            map.Add(new WP6_FunctionKey(0xDE, 105), MergeGroup.local_off);
            map.Add(new WP6_FunctionKey(0xDE, 106), MergeGroup.look_on);
            map.Add(new WP6_FunctionKey(0xDE, 107), MergeGroup.look_off);
            map.Add(new WP6_FunctionKey(0xDE, 108), MergeGroup.mrgcmnd_on);
            map.Add(new WP6_FunctionKey(0xDE, 109), MergeGroup.mrgcmnd_off);
            map.Add(new WP6_FunctionKey(0xDE, 110), MergeGroup.nestdata_on);
            map.Add(new WP6_FunctionKey(0xDE, 111), MergeGroup.nestdata_off);
            map.Add(new WP6_FunctionKey(0xDE, 112), MergeGroup.nestform_on);
            map.Add(new WP6_FunctionKey(0xDE, 113), MergeGroup.nestform_off);
            map.Add(new WP6_FunctionKey(0xDE, 114), MergeGroup.nestmacro_on);
            map.Add(new WP6_FunctionKey(0xDE, 115), MergeGroup.nestmacro_off);
            map.Add(new WP6_FunctionKey(0xDE, 116), MergeGroup.NTOC_on);
            map.Add(new WP6_FunctionKey(0xDE, 117), MergeGroup.NTOC_off);
            map.Add(new WP6_FunctionKey(0xDE, 118), MergeGroup.oncancel_on);
            map.Add(new WP6_FunctionKey(0xDE, 119), MergeGroup.oncancel_off);
            map.Add(new WP6_FunctionKey(0xDE, 120), MergeGroup.onerror_on);
            map.Add(new WP6_FunctionKey(0xDE, 121), MergeGroup.onerror_off);
            map.Add(new WP6_FunctionKey(0xDE, 122), MergeGroup.prompt_on);
            map.Add(new WP6_FunctionKey(0xDE, 123), MergeGroup.prompt_off);
            map.Add(new WP6_FunctionKey(0xDE, 124), MergeGroup.statusprompt_on);
            map.Add(new WP6_FunctionKey(0xDE, 125), MergeGroup.statusprompt_off);
            map.Add(new WP6_FunctionKey(0xDE, 126), MergeGroup.strlen_on);
            map.Add(new WP6_FunctionKey(0xDE, 127), MergeGroup.strlen_off);
            map.Add(new WP6_FunctionKey(0xDE, 128), MergeGroup.strpos_on);
            map.Add(new WP6_FunctionKey(0xDE, 129), MergeGroup.strpos_off);
            map.Add(new WP6_FunctionKey(0xDE, 130), MergeGroup.substdata_on);
            map.Add(new WP6_FunctionKey(0xDE, 131), MergeGroup.substdata_off);
            map.Add(new WP6_FunctionKey(0xDE, 132), MergeGroup.substform_on);
            map.Add(new WP6_FunctionKey(0xDE, 133), MergeGroup.substform_off);
            map.Add(new WP6_FunctionKey(0xDE, 134), MergeGroup.substr_on);
            map.Add(new WP6_FunctionKey(0xDE, 135), MergeGroup.substr_off);
            map.Add(new WP6_FunctionKey(0xDE, 136), MergeGroup.system_on);
            map.Add(new WP6_FunctionKey(0xDE, 137), MergeGroup.system_off);
            map.Add(new WP6_FunctionKey(0xDE, 138), MergeGroup.tolower_on);
            map.Add(new WP6_FunctionKey(0xDE, 139), MergeGroup.tolower_off);
            map.Add(new WP6_FunctionKey(0xDE, 140), MergeGroup.touppper_on);
            map.Add(new WP6_FunctionKey(0xDE, 141), MergeGroup.toupper_off);
            map.Add(new WP6_FunctionKey(0xDE, 142), MergeGroup.variable_on);
            map.Add(new WP6_FunctionKey(0xDE, 143), MergeGroup.variable_off);
            map.Add(new WP6_FunctionKey(0xDE, 144), MergeGroup.wait_on);
            map.Add(new WP6_FunctionKey(0xDE, 145), MergeGroup.wait_off);
            map.Add(new WP6_FunctionKey(0xDE, 146), MergeGroup.while_on);
            map.Add(new WP6_FunctionKey(0xDE, 147), MergeGroup.while_off);
            map.Add(new WP6_FunctionKey(0xDE, 148), MergeGroup.postnet_on);
            map.Add(new WP6_FunctionKey(0xDE, 149), MergeGroup.postnet_off);
